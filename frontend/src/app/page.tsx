...
export default function HomePage() {
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a", color: "#f5f5f5", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      {/* NAV */}
      <nav style={{ borderBottom: "1px solid #1a1a1a", padding: "0 2rem", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, background: "rgba(10,10,10,0.9)", backdropFilter: "blur(12px)", zIndex: 50 }}>
      ...
      <section style={{ maxWidth: 760, margin: "0 auto", padding: "7rem 2rem 5rem", textAlign: "center" }}>
        <div style={{ display: "inline-block", background: "#14532d", color: "#22c55e", fontSize: 12, fontWeight: 600, padding: "4px 12px", borderRadius: 20, marginBottom: 28, letterSpacing: "0.05em" }}>
          GRATIS · SIN TARJETA
        </div>
      ...
      {/* DEMO CARD */}
      <section style={{ maxWidth: 700, margin: "0 auto 6rem", padding: "0 2rem" }}>
        <div style={{ background: "#111", border: "1px solid #222", borderRadius: 16, padding: "2rem", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", gap: 12, marginBottom: 20 }}>
            <div style={{ width: 80, height: 52, background: "#1a1a1a", borderRadius: 6, flexShrink: 0 }} />
            <div>
              <p style={{ fontWeight: 600, marginBottom: 4 }}>Cómo funciona la IA en 2024</p>
          ...
          <div>
            ...
            {["Los LLMs aprenden patrones estadísticos del lenguaje, no reglas explícitas", "El scaling de parámetros sigue siendo la estrategia más efectiva", "La alineación es el problema técnico más crítico del momento"].map((pt, i) => (
      ...
      <section style={{ maxWidth: 900, margin: "0 auto 6rem", padding: "0 2rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
          {[
            ...
            { icon: "🌍", title: "Multiidioma", desc: "Español, inglés, francés, portugués y más" },
            ...
            <div key={f.title} style={{ background: "#111", border: "1px solid #1a1a1a", borderRadius: 12, padding: "1.5rem" }}>
      ...
      <footer style={{ borderTop: "1px solid #1a1a1a", padding: "2rem", textAlign: "center" }}>
        <p style={{ fontSize: 13, color: "#555" }}>© 2024 ResumidorAI · Hecho con Claude AI</p>
      </footer>
    </div>
  );
}
